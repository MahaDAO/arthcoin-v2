...
// // File: contracts\interfaces\IChainlinkAggregatorV3.sol
...
//     mapping(uint256 => IChainlinkAggregatorV3) private assetsMap;
...
//     constructor() public {
//         //mainnet
//         assetsMap[1] = IChainlinkAggregatorV3(0xF4030086522a5bEEa4988F8cA5B36dbC97BeE88c);
//         assetsMap[2] = IChainlinkAggregatorV3(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419);
//         assetsMap[3] = IChainlinkAggregatorV3(0x24551a8Fb2A7211A25a17B1481f043A8a8adC7f2);
//         assetsMap[4] = IChainlinkAggregatorV3(0xDC3EA94CD0AC27d9A86C180091e7f78C683d3699);
//         assetsMap[5] = IChainlinkAggregatorV3(0x2c1d072e956AFFC0D435Cb7AC38EF18d24d9127c);
//         assetsMap[0] = IChainlinkAggregatorV3(0x5f4eC3Df9cbd43714FE2740f5E3616155c5b8419);
//         assetsMap[uint256(0xeF9Cd7882c067686691B6fF49e650b43AFBBCC6B)] = IChainlinkAggregatorV3(0x80070f7151BdDbbB1361937ad4839317af99AE6c);
...
//         /*
//         //rinkeby
//         assetsMap[1] = IChainlinkAggregatorV3(0xECe365B379E1dD183B20fc5f022230C044d51404);
//         assetsMap[2] = IChainlinkAggregatorV3(0x8A753747A1Fa494EC906cE90E9f37563A8AF630e);
//         assetsMap[3] = IChainlinkAggregatorV3(0xd8bD0a1cB028a31AA859A21A3758685a95dE4623);
//         assetsMap[4] = IChainlinkAggregatorV3(0xE96C4407597CD507002dF88ff6E0008AB41266Ee);
//         assetsMap[5] = IChainlinkAggregatorV3(0xd8bD0a1cB028a31AA859A21A3758685a95dE4623);
//         assetsMap[0] = IChainlinkAggregatorV3(0x8A753747A1Fa494EC906cE90E9f37563A8AF630e);
//         assetsMap[uint256(0xaf30F6A6B09728a4e793ED6d9D0A7CcBa192c229)] = IChainlinkAggregatorV3(0xcf74110A02b1D391B27cE37364ABc3b279B1d9D1);
...
//             return getMKRPrice();
//         }
//         IChainlinkAggregatorV3 assetsPrice = assetsMap[underlying];
...
//         IChainlinkAggregatorV3 assetsPrice = assetsMap[3];
//         IChainlinkAggregatorV3 ethPrice = assetsMap[0];
...
//         assetsMap[uint256(asset)] = IChainlinkAggregatorV3(aggergator);
...
//         require(underlying>0 , "underlying cannot be zero");
//         assetsMap[underlying] = IChainlinkAggregatorV3(aggergator);
