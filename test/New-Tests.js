...
contract('ARTH', async (accounts) => {
  ...
  // 	await col_instance_USDC.transfer(pool_instance_USDC.address, COLLATERAL_SEED_DEC18, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
  // 	await col_instance_USDT.transfer(pool_instance_USDT.address, COLLATERAL_SEED_DEC18, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
  ...
  it("Deploys a vesting contract and then executes a governance proposal to revoke it", async () => {
    ...
    await fxsInstance.approve(vestingInstance.address, new BigNumber("100000e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await fxsInstance.transfer(vestingInstance.address, new BigNumber("100000e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    let proposal_id = await governanceInstance.latestProposalIds.call(COLLATERAL_ARTH_AND_FXS_OWNER);
  ...
  it('PART 0: Normal stakes at CR = 100%', async () => {
    ...
    await pair_instance_ARTH_USDC.transfer(accounts[9], new BigNumber("10e6"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    await pair_instance_ARTH_USDC.approve(stakingInstance_ARTH_USDC.address, uni_pool_tokens_1, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    console.log("accounts[1] approve ARTH_USDC staking pool for 7.5 (E6) LP tokens");
    const uni_pool_1st_stake_1 = new BigNumber(await pair_instance_ARTH_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const fxs_1st_stake_1 = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const rewards_balance_1st_stake_1 = new BigNumber(await stakingInstance_ARTH_USDC.rewards.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);

    await stakingInstance_ARTH_USDC.stake(uni_pool_tokens_1, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    console.log("accounts[1] balanceOf:", (new BigNumber(await stakingInstance_ARTH_USDC.balanceOf(COLLATERAL_ARTH_AND_FXS_OWNER))).div(BIG6).toNumber());
    console.log("accounts[1] boostedBalanceOf:", (new BigNumber(await stakingInstance_ARTH_USDC.boostedBalanceOf(COLLATERAL_ARTH_AND_FXS_OWNER))).div(BIG6).toNumber());
    console.log("");
    ...
    await stakingInstance_ARTH_USDC.renewIfApplicable({ from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    console.log("");
    // Show the reward
    const staking_fxs_earned_1 = new BigNumber(await stakingInstance_ARTH_USDC.earned.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const staking_fxs_earned_9 = new BigNumber(await stakingInstance_ARTH_USDC.earned.call(accounts[9])).div(BIG18);
    ...
    // await stakingInstance_ARTH_USDC.getReward({ from: COLLATERAL_ARTH_AND_FXS_OWNER });

    // Note the UNI POOL and FXS amounts after the reward
    const uni_pool_post_reward_1 = new BigNumber(await pair_instance_ARTH_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const fxs_post_reward_1 = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    ...
    console.log("");
    await time.advanceBlock();
    const uni_pool_balance_1 = new BigNumber(await pair_instance_ARTH_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const staking_fxs_ew_earned_1 = new BigNumber(await stakingInstance_ARTH_USDC.earned.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    ...
    await stakingInstance_ARTH_USDC.withdraw(uni_pool_tokens_1, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await time.advanceBlock();
    console.log("");

    const fxs_after_withdraw_0 = (new BigNumber(await fxsInstance.balanceOf(COLLATERAL_ARTH_AND_FXS_OWNER))).div(BIG18);
    ...
    // Show the reward
    const staking_fxs_part2_earned_1 = new BigNumber(await stakingInstance_ARTH_USDC.earned.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const staking_fxs_part2_earned_9 = new BigNumber(await stakingInstance_ARTH_USDC.earned.call(accounts[9])).div(BIG18);
    console.log("accounts[1] staking earned():", staking_fxs_part2_earned_1.toString());

    const uni_pool_2nd_time_balance = new BigNumber(await pair_instance_ARTH_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const fxs_2nd_time_balance = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
  ...
  it('Mint some ARTH using USDC as collateral (collateral ratio = 1) [mint1t1ARTH]', async () => {
    ...
    console.log("FXS price (USD): ", (new BigNumber(await arthInstance.fxs_price.call()).div(BIG6)).toNumber());
    ...
    const arth_before = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const collateral_before = new BigNumber(await col_instance_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    ...
    await col_instance_USDC.approve(pool_instance_USDC.address, collateral_amount, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    // Mint some ARTH
    ...
    await pool_instance_USDC.mint1t1ARTH(collateral_amount, ARTH_out_min, { from: COLLATERAL_ARTH_AND_FXS_OWNER });

    // Note the collateral and ARTH amounts after minting
    const arth_after = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const collateral_after = new BigNumber(await col_instance_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
  ...
  it('Redeem some ARTH for USDC (collateral ratio >= 1) [redeem1t1ARTH]', async () => {
    ...
    await col_instance_USDC.transfer(pool_instance_USDC.address, THREE_THOUSAND_DEC6, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await col_instance_USDT.transfer(pool_instance_USDT.address, THREE_THOUSAND_DEC6, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    await arthInstance.approve(pool_instance_USDC.address, arth_amount, { from: COLLATERAL_ARTH_AND_FXS_OWNER });

    // Redeem some ARTH
    await pool_instance_USDC.redeem1t1ARTH(arth_amount, new BigNumber("10e6"), { from: COLLATERAL_ARTH_AND_FXS_OWNER }); // Get at least 10 USDC out, roughly 90% slippage limit (testing purposes)
    console.log("accounts[1] redeem1t1() with 100 ARTH");
    // Collect redemption
    await time.advanceBlock();
    await time.advanceBlock();
    await time.advanceBlock();
    await pool_instance_USDC.collectRedemption({ from: COLLATERAL_ARTH_AND_FXS_OWNER });
  ...
  it("Reduces the collateral ratio: 1-to-1 Phase => Fractional Phase", async () => {
    ...
    // await arthInstance.mint(tokensToMint, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    // totalSupplyARTH = new BigNumber(await arthInstance.totalSupply.call()).div(BIG18).toNumber();
    // console.log("totalSupplyARTH: ", totalSupplyARTH);
  ...
  it('Mint some ARTH using FXS and USDC (collateral ratio between .000001 and .999999) [mintFractionalARTH]', async () => {
    ...
    console.log("accounts[1] votes initial:", (new BigNumber(await fxsInstance.getCurrentVotes(COLLATERAL_ARTH_AND_FXS_OWNER))).div(BIG18).toString());
    // Note the collateral ratio
    const collateral_ratio_before = new BigNumber(await arthInstance.global_collateral_ratio.call()).div(BIG6);
    console.log("collateral_ratio_before: ", collateral_ratio_before.toNumber());

    // Note the FXS, ARTH, and FAKE amounts before minting
    const fxs_before = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const arth_before = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const collateral_before = new BigNumber(await col_instance_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const pool_collateral_before = new BigNumber(await col_instance_USDC.balanceOf.call(pool_instance_USDC.address)).div(BIG6);
    bal_fxs = fxs_before;
    ...
    await fxsInstance.approve(pool_instance_USDC.address, fxs_amount, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    const collateral_amount = new BigNumber("100e6");
    await col_instance_USDC.approve(pool_instance_USDC.address, collateral_amount, { from: COLLATERAL_ARTH_AND_FXS_OWNER });

    await pool_instance_USDC.mintFractionalARTH(collateral_amount, fxs_amount, new BigNumber("10e6"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    console.log("accounts[1] mintFractionalARTH() with 100 USDC and 500 FXS");

    // Note the FXS, ARTH, and FAKE amounts after minting
    const fxs_after = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const arth_after = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const collateral_after = new BigNumber(await col_instance_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const pool_collateral_after = new BigNumber(await col_instance_USDC.balanceOf.call(pool_instance_USDC.address)).div(BIG6);
    ...
    console.log("accounts[1] votes final:", (new BigNumber(await fxsInstance.getCurrentVotes(COLLATERAL_ARTH_AND_FXS_OWNER))).div(BIG18).toString());
  ...
  it("Set the pool ceiling and try to mint above it", async () => {
    ...
    await fxsInstance.approve(pool_instance_USDC.address, new BigNumber("1000e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await col_instance_USDC.approve(pool_instance_USDC.address, new BigNumber("1000e6"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await expectRevert.unspecified(pool_instance_USDC.mintFractionalARTH(new BigNumber("1000e18"), new BigNumber("1000e18"), 0, { from: COLLATERAL_ARTH_AND_FXS_OWNER }));
    await pool_instance_USDC.setPoolParameters(new BigNumber("5000000e18"), 7500, 1, { from: POOL_CREATOR });
  })



  it('SHOULD FAIL: Mint some ARTH using FXS and USDC, but doesn\'t send in enough FXS [mintFractionalARTH]', async () => {
    console.log("=========================mintFractionalARTH=========================");
    ...
    await expectRevert.unspecified(pool_instance_USDC.mintFractionalARTH(collateral_amount, fxs_amount, new BigNumber("10e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER }));
    console.log("accounts[1] mintFractionalARTH() with 100 USDC and 5 FXS");
  ...
  it('Redeem some ARTH for FXS and USDC (collateral ratio between .000001 and .999999) [redeemFractionalARTH]', async () => {
    ...
    // Note the FXS, ARTH, and FAKE amounts before redeeming
    const fxs_before = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const arth_before = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const collateral_before = new BigNumber(await col_instance_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const pool_collateral_before = new BigNumber(await col_instance_USDC.balanceOf.call(pool_instance_USDC.address)).div(BIG6);
    ...
    col_bal_usdc = collateral_before;
    pool_bal_usdc = pool_collateral_before;
    console.log("accounts[1] FXS balance:", bal_arth.toNumber());
    ...
    // Redeem some ARTH
    await pool_instance_USDC.redeemFractionalARTH(arth_amount, new BigNumber("5e18"), new BigNumber("125e6"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    // Note the FXS, ARTH, and FAKE amounts after redeeming
    const fxs_after = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const arth_after = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const collateral_after = new BigNumber(await col_instance_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const pool_collateral_after = new BigNumber(await col_instance_USDC.balanceOf.call(pool_instance_USDC.address)).div(BIG6);
  ...
  it('Mint some ARTH using FXS and USDC (collateral ratio between .000001 and .999999) [mintFractionalARTH]', async () => {
    ...
    await pool_instance_USDC.mintFractionalARTH(collateral_amount, fxs_amount, new BigNumber("10e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    console.log("accounts[1] mintFractionalARTH() with 10,000 USDC and 50,000 FXS");
  ...
  it('Recollateralizes the system using recollateralizeARTH()', async () => {
    ...
    const global_collateral_ratio = (new BigNumber(arth_info[3]));
    const global_collat_value = (new BigNumber(arth_info[4]));
    const effective_collateral_ratio_E6 = (global_collat_value.multipliedBy(1e6).div(arth_total_supply)).toNumber(); // Returns it in 1e6
    const effective_collateral_ratio = effective_collateral_ratio_E6 / 1e6;
    let available_to_recollat = ((global_collateral_ratio.multipliedBy(arth_total_supply).minus(arth_total_supply.multipliedBy(effective_collateral_ratio_E6))).div(1e6).div(1e18)).toNumber();
    ...
    await col_instance_USDC.approve(pool_instance_USDC.address, USDC_amount, { from: COLLATERAL_ARTH_AND_FXS_OWNER });

    // Redeem some ARTH
    await pool_instance_USDC.recollateralizeARTH(USDC_amount, new BigNumber("10e6"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
  ...
  it('Mint some ARTH using FXS (collateral ratio = 0) [mintAlgorithmicARTH]', async () => {
    ...
    // Note the FXS and ARTH amounts before minting
    const fxs_before = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const arth_before = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    bal_fxs = fxs_before;
    bal_arth = arth_before;
    ...
    // Mint some ARTH
    await pool_instance_USDC.mintAlgorithmicARTH(fxs_amount, new BigNumber("10e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    console.log("accounts[1] mintAlgorithmicARTH() using 10,000 FXS");

    // Note the FXS and ARTH amounts after minting
    const fxs_after = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const arth_after = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
  ...
  it('Redeem some ARTH for FXS (collateral ratio = 0) [redeemAlgorithmicARTH]', async () => {
    ...
    // Redeem some ARTH
    await pool_instance_USDC.redeemAlgorithmicARTH(arth_amount, new BigNumber("10e6"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    const fxs_after = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const arth_after = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    //const fxs_unclaimed = new BigNumber(await pool_instance_USDC.getRedeemFXSBalance.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    //console.log("bal_fxs change: ", fxs_after.toNumber() - bal_fxs);
    //console.log("bal_fxs sitting inside Pool_USDC waiting to be claimed by COLLATERAL_ARTH_AND_FXS_OWNER: ", fxs_unclaimed);
  ...
  it("Buys back collateral using FXS [should fail if CR = 0]", async () => {
    ...
    // FXS price
    const fxs_price = new BigNumber(await arthInstance.fxs_price()).div(BIG6);
    console.log("fxs_price: $", fxs_price.toNumber());

    // Buy back some ARTH
    console.log("accounts[1] buyBackFXS() using 40,000 FXS");
    await pool_instance_USDC.buyBackFXS(fxs_amount, new BigNumber("10e6"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
  ...
  it('PART 1: Normal stakes at CR = 0', async () => {
    ...
    const fxs_after_withdraw_0 = (new BigNumber(await fxsInstance.balanceOf(COLLATERAL_ARTH_AND_FXS_OWNER))).div(BIG18);
    console.log("accounts[1] FXS balance change:", (fxs_after_withdraw_0).minus(fxs_1st_stake_1).toNumber());
    console.log("accounts[1] vote balance:", new BigNumber(await fxsInstance.getCurrentVotes(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18).toNumber());
    console.log("accounts[1] FXS balance:", new BigNumber(await fxsInstance.balanceOf(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18).toNumber());
    console.log("====================================================================");
    ...
    const uni_pool_2nd_time_balance = new BigNumber(await pair_instance_ARTH_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const fxs_2nd_time_balance = new BigNumber(await fxsInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    const rewards_earned_2nd_time = new BigNumber(await stakingInstance_ARTH_USDC.earned.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    console.log("accounts[1] LP token balance:", uni_pool_2nd_time_balance.toString());
    console.log("accounts[1] FXS balance:", fxs_2nd_time_balance.toString());
  ...
  it('PART 2: Locked stakes', async () => {
    ...
    await pair_instance_ARTH_USDC.approve(stakingInstance_ARTH_USDC.address, uni_pool_normal_1, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await pair_instance_ARTH_USDC.approve(stakingInstance_ARTH_USDC.address, uni_pool_normal_9, { from: accounts[9] });

    // Stake Normal
    await stakingInstance_ARTH_USDC.stake(uni_pool_normal_1, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    await pair_instance_ARTH_USDC.approve(stakingInstance_ARTH_USDC.address, uni_pool_locked_1_sum, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    ...
    // const arth_before_1_locked = new BigNumber(await arthInstance.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18);
    ...
    // Stake Locked
    // account[1]
    await stakingInstance_ARTH_USDC.stakeLocked(uni_pool_locked_1, 7 * 86400, { from: COLLATERAL_ARTH_AND_FXS_OWNER }); // 15 days
    await stakingInstance_ARTH_USDC.stakeLocked(new BigNumber("25e5"), 548 * 86400, { from: COLLATERAL_ARTH_AND_FXS_OWNER }); // 270 days
    ...
    const locked_stake_structs_1 = await stakingInstance_ARTH_USDC.lockedStakesOf.call(COLLATERAL_ARTH_AND_FXS_OWNER);
    ...
    const regular_balance_1 = new BigNumber(await stakingInstance_ARTH_USDC.balanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const boosted_balance_1 = new BigNumber(await stakingInstance_ARTH_USDC.boostedBalanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const unlocked_balance_1 = new BigNumber(await stakingInstance_ARTH_USDC.unlockedBalanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    const locked_balance_1 = new BigNumber(await stakingInstance_ARTH_USDC.lockedBalanceOf.call(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG6);
    ...
    await expectRevert.unspecified(stakingInstance_ARTH_USDC.withdrawLocked(locked_stake_structs_1[0].kek_id, { from: COLLATERAL_ARTH_AND_FXS_OWNER }));
    ...
    await stakingInstance_ARTH_USDC.withdrawLocked(locked_stake_structs_1[0].kek_id, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await expectRevert.unspecified(stakingInstance_ARTH_USDC.withdrawLocked(locked_stake_structs_9[0].kek_id, { from: accounts[9] }));
    ...
    const staking_fxs_earned_28_1 = new BigNumber(await stakingInstance_ARTH_USDC.earned.call(accounts[1])).div(BIG18);
    const staking_fxs_earned_28_9 = new BigNumber(await stakingInstance_ARTH_USDC.earned.call(accounts[9])).div(BIG18);
    ...
    await stakingInstance_ARTH_USDC.getReward({ from: accounts[9] });
    await expectRevert.unspecified(stakingInstance_ARTH_USDC.withdrawLocked(locked_stake_structs_1[1].kek_id, { from: COLLATERAL_ARTH_AND_FXS_OWNER }));

    console.log("UNLOCKING ALL STAKES");
    await stakingInstance_ARTH_USDC.unlockStakes({ from: STAKING_OWNER });
    await stakingInstance_ARTH_USDC.withdrawLocked(locked_stake_structs_1[1].kek_id, { from: COLLATERAL_ARTH_AND_FXS_OWNER });




    await fxsInstance.transfer(stakingInstance_ARTH_USDC.address, new BigNumber("100000e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    console.log("stakingInstance FXS balance:", new BigNumber(await fxsInstance.balanceOf(stakingInstance_ARTH_USDC.address)).div(BIG18).toNumber());
    await stakingInstance_ARTH_USDC.getReward({ from: COLLATERAL_ARTH_AND_FXS_OWNER });
    console.log("accounts[1] FXS balance:", new BigNumber(await fxsInstance.balanceOf(COLLATERAL_ARTH_AND_FXS_OWNER)).div(BIG18).toNumber());
  });
  ...
  it("Does a fair launch", async () => {
    console.log("====================================================================");
    await fxsInstance.transfer(stakingInstance_ARTH_WETH.address, new BigNumber("1000000e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await pair_instance_ARTH_WETH.transfer(accounts[2], new BigNumber("1e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });
    await pair_instance_ARTH_WETH.transfer(accounts[3], new BigNumber("1e18"), { from: COLLATERAL_ARTH_AND_FXS_OWNER });

    console.log("staking contract FXS balance:", (new BigNumber(await fxsInstance.balanceOf(stakingInstance_ARTH_WETH.address))).div(BIG18).toNumber());
    ...
    const staking_fxs_earned_2 = new BigNumber(await stakingInstance_ARTH_WETH.earned(accounts[2])).div(BIG18);
    const staking_fxs_earned_3 = new BigNumber(await stakingInstance_ARTH_WETH.earned(accounts[3])).div(BIG18);
    ...
    for (let i = 0; i < 3; i++) {
      ...
      // Make sure there is a valid period for the contract
      await stakingInstance_ARTH_WETH.renewIfApplicable({ from: COLLATERAL_ARTH_AND_FXS_OWNER });
      ...
      // Show the reward
      mid_staking_fxs_earned_2 = new BigNumber(await stakingInstance_ARTH_WETH.earned(accounts[2])).div(BIG18);
      mid_staking_fxs_earned_3 = new BigNumber(await stakingInstance_ARTH_WETH.earned(accounts[3])).div(BIG18);
