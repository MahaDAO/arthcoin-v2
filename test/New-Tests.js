...
const UniswapV2Router02_Modified = artifacts.require("UniswapV2Router02");

// Collateral
const WETH = artifacts.require("MockWETH");
const FakeCollateral_USDC = artifacts.require("MockUSDC");
...
// Oracles
const UniswapPairOracle_FRAX_WETH = artifacts.require("UniswapPairOracle_ARTH_WETH");
const UniswapPairOracle_FRAX_USDT = artifacts.require("UniswapPairOracle_ARTH_USDT");
const UniswapPairOracle_FRAX_USDC = artifacts.require("UniswapPairOracle_ARTH_USDC");
// const UniswapPairOracle_FRAX_yUSD = artifacts.require("Oracle/Fakes/UniswapPairOracle_FRAX_yUSD");
const UniswapPairOracle_FXS_WETH = artifacts.require("UniswapPairOracle_ARTHX_WETH");
const UniswapPairOracle_FXS_USDT = artifacts.require("UniswapPairOracle_ARTHX_USDT");
const UniswapPairOracle_FXS_USDC = artifacts.require("UniswapPairOracle_ARTHX_USDC");
// const UniswapPairOracle_FXS_yUSD = artifacts.require("Oracle/Fakes/UniswapPairOracle_FXS_yUSD");
const UniswapPairOracle_USDT_WETH = artifacts.require("UniswapPairOracle_USDT_WETH");
const UniswapPairOracle_USDC_WETH = artifacts.require("UniswapPairOracle_USDC_WETH");
const UniswapPairOracle_6DEC_WETH = artifacts.require("UniswapPairOracle_6DEC_WETH");
...
// FRAX core
const FRAXStablecoin = artifacts.require("ARTHStablecoin");
const FRAXShares = artifacts.require("ARTHShares");
const StakingRewards_FRAX_WETH = artifacts.require("Stake_ARTH_WETH.sol");
const StakingRewards_FRAX_USDC = artifacts.require("Stake_ARTH_USDC.sol");
...
const StakingRewards_FXS_WETH = artifacts.require("Stake_ARTHX_WETH.sol");
...
contract('ARTH', async (accounts) => {
  ...
  it("Mints 6DEC 1-to-1", async () => {
    ...
    const collateral_ratio_after = new BigNumber(await arthControllerInstance.getGlobalCollateralRatio.call()).div(BIG6);
