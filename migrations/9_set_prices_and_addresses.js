...
module.exports = async function (deployer, network, accounts) {
  ...
  console.log(" NOTE: - arthxPrice_initial: ", arthxPrice_initial.toString(), "USD = 1 ARTHS")
  ...
  console.log(" NOTE: - arthxPrice_from_ARTHS_WETH: ", arthxPrice_from_ARTHS_WETH.toString(), "ARTHX = 1 WETH")
