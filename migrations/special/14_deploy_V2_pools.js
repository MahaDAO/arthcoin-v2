...
module.exports = async function (deployer, network, accounts) {
  ...
  await Promise.all([
    deployer.deploy(Pool_USDC_V2, arthInstance.address, fxsInstance.address, col_instance_USDC.address, POOL_CREATOR, timelockInstance.address, FIVE_MILLION_DEC18),
    deployer.deploy(Pool_USDT_V2, arthInstance.address, fxsInstance.address, col_instance_USDT.address, POOL_CREATOR, timelockInstance.address, FIVE_MILLION_DEC18)
  ])
  ...
  await Promise.all([
    await col_instance_USDC.transfer(pool_instance_USDC_V2.address, TWENTY_FIVE_DEC6, { from: COLLATERAL_ARTH_AND_FXS_OWNER }),
    await col_instance_USDT.transfer(pool_instance_USDT_V2.address, TWENTY_FIVE_DEC6, { from: COLLATERAL_ARTH_AND_FXS_OWNER }),
  ]);
  ...
  await arthInstance.addPool(pool_instance_USDC_V2.address, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
  await arthInstance.addPool(pool_instance_USDT_V2.address, { from: COLLATERAL_ARTH_AND_FXS_OWNER });

  // Remove the old pools
  console.log(chalk.yellow('===== REMOVE THE OLD POOLS ====='));
  // await arthInstance.removePool(pool_instance_USDC.address, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
  // await arthInstance.removePool(pool_instance_USDT.address, { from: COLLATERAL_ARTH_AND_FXS_OWNER });
  await arthInstance.removePool('0x5e57064B79c8A0854858e13614A7024ccB8F09E9', { from: COLLATERAL_ARTH_AND_FXS_OWNER });
  await arthInstance.removePool('0xF8eC470B09d8636546fCd6A0922046e3fE9940C7', { from: COLLATERAL_ARTH_AND_FXS_OWNER });
